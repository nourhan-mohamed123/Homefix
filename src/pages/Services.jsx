        ...
        <div className="p-5 flex flex-col flex-1">
          ...
          <div className="mt-auto pt-4 border-t border-slate-50 flex items-center justify-between">
            <div className="flex flex-col">
              <span className="text-[9px] text-slate-400 uppercase tracking-[0.2em] font-black mb-0.5">Starts at</span>
              <div className="flex items-baseline gap-0.5">
                <span className="text-xs font-bold text-homefix-primary">EGP</span>
                <span className="text-xl font-black text-homefix-text tabular-nums leading-none">{price}</span>
              </div>
            </div>
