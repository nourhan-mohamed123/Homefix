...
--
-- Host: localhost
-- Generation Time: Feb 12, 2026 at 06:39 AM
...
--
-- Creation: Feb 12, 2026 at 06:33 AM
--
...
CREATE TABLE `users` (
  ...
  `account_type` enum('customer','provider','admin') DEFAULT NULL,
...
INSERT INTO `users` (`user_id`, `password`, `email`, `address`, `city`, `created_at`, `full_name`, `account_type`, `isActive`) VALUES
(1, '12323434545', 'keroloshanna953@gmail.com', NULL, 'Assiut', '2026-02-11 12:11:33', 'Kerolos Hanna', 'customer', 1),
(2, '12323434545', 'kerolosahdy199@gmail.com', NULL, 'Cairo', '2026-02-11 12:14:42', 'Kerolos Ahdy', 'provider', 1);
